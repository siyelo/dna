...
* RD - a meetup where someone presents something interesting that they've learned recently (see above). Here's a page in Swedish which lists the "topics we talked about from 2002-2012":https://www.siyelo.com/om-crisp/crisp-internutbildning
* GDWS - Get Drunk With Siyelo - a pub night that happens from time to time
...
* Write "articles":http://blog.siyelo.com and "books":https://www.siyelo.com/bocker-och-produkter (sometimes in pairs). 
* Create and teach "courses":https://www.siyelo.com/courses (gives the teacher a very strong motivation to learn the topic!)
