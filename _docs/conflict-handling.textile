...
Conflict handling gets a bit tricky with organizations like Siyelo, with everything bottom-up and no managers. We've done pretty OK so far, but we want to get better.
...
The policy lives in a google doc and has been "signed" by about 80% of the Siyeloers so far (as of Jan 2015) 
